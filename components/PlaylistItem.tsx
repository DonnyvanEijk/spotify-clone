    ...
    <ContextMenu.Root modal={false}>
      <ContextMenu.Trigger>
        <Link href={`/playlist/${playlistId}`}>
          ...
          >
            <div className="relative w-full pt-[100%] rounded-2xl overflow-hidden bg-white/10">
              <img
            ...
            <div className="flex flex-col items-start w-full pt-3 gap-y-1 text-left">
              ...
              <div className="relative w-full overflow-hidden">
                <p className="text-neutral-300 text-xs whitespace-nowrap transition-transform duration-[15s] ease-linear group-hover:translate-x-full">
